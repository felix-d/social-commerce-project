...
gulp.task('compress-js', ['move-js'], function() {
...
//move js files from bower components into dev
gulp.task('move-js', ['browserify-watch'], function(){
...
gulp.task('do-js', ['compress-js'], function() {return;});

gulp.task('watch', ['do-js'], function(){
