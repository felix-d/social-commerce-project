...
},{"superagent":183}],183:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"emitter":1,"reduce":163}],184:[function(require,module,exports){
'use strict';
...
exports['default'] = _reflux2['default'].createActions(['closeInitModal', 'closeNextStepModal']);
module.exports = exports['default'];

},{"reflux":179}],185:[function(require,module,exports){
'use strict';

var Reflux = require('reflux');

var WishlistActions = Reflux.createActions(['add', 'remove', 'resetIdLastSetProduct', 'setWishlist']);

module.exports = WishlistActions;

},{"reflux":179}],186:[function(require,module,exports){
(function (__filename){
'use strict';
...
var _productsActionsAPIActions = require('../../products/actions/APIActions');

var _productsActionsAPIActions2 = _interopRequireDefault(_productsActionsAPIActions);

var _meActionsWishlistActions = require('../../me/actions/WishlistActions');

var _meActionsWishlistActions2 = _interopRequireDefault(_meActionsWishlistActions);
...
var initModalClosed = false;
var nextStepModalClosed = false;

var _showUsersPics = null;
var _networkTraversing = null;
var _displayReviewsInUserPages = null;
var _displayAllReviews = null;

function getState() {
  return _extends({}, _userInfo, {
    initModalClosed: initModalClosed,
    nextStepModalClosed: nextStepModalClosed,
...
exports['default'] = _reflux2['default'].createStore({
  ...
  listenables: [_actionsUserActions2['default'], _productsActionsAPIActions2['default'], _meActionsWishlistActions2['default']],

  init: function init() {
    var _this = this;

    _superagent2['default'].get('/phase2/userpage/').end(function (err, res) {
      if (res !== undefined) {
        _userInfo = JSON.parse(res.text);
        debug('Got user info', _userInfo);
        _this.trigger(getState());
      }
    });
  },
  onAdd: function onAdd(w) {
    _userInfo.products = _userInfo.products.map(function (p) {
      if (w.id === p.id) {
        p.iswish = true;
      }
      return p;
  ...
  isNetworkTraversingAllowed: function isNetworkTraversingAllowed() {
    return _networkTraversing;
  },

  displayReviewsInUsersPages: function displayReviewsInUsersPages() {
    return _displayReviewsInUserPages;
  },

  showUsersPics: function showUsersPics() {
    return _showUsersPics;
  },

  displayAllReviews: function displayAllReviews() {
    return _displayAllReviews;
  },

  onFetchInitialDataCompleted: function onFetchInitialDataCompleted(data) {
    var showUsersPics = data.showUsersPics;
    var displayReviewsInUserPages = data.displayReviewsInUserPages;
    var networkTraversing = data.networkTraversing;
    var displayAllReviews = data.displayAllReviews;
  ...
  onCloseInitModal: function onCloseInitModal() {
    debug('Init modal closed');
    initModalClosed = true;
    this.trigger(getState());
  },

  onCloseNextStepModal: function onCloseNextStepModal() {
...
}).call(this,"/src/js/phase2_app/me/stores/UserStore.js")

},{"../../me/actions/WishlistActions":185,"../../products/actions/APIActions":187,"../actions/UserActions":184,"debug":2,"reflux":179,"superagent":183}],187:[function(require,module,exports){
'use strict';
...
actions.fetchInitialData.listen(function handler() {
  ...
  _superagent2['default'].get('get-initial-data').end(function (err, res) {
    if (err) {
      _this.failed(err);
    } else {
...
},{"reflux":179,"superagent":183}],188:[function(require,module,exports){
(function (__filename){
'use strict';
...
var _utilsUtilsJsx = require('./utils/Utils.jsx');
...
function track(hook, _data) {
  var data = _extends({}, _data, { at: (0, _utilsUtilsJsx.getLocation)() });
  debug(hook, data);
  _superagent2['default'].post(_utilsConfig.TRACKING_URL).set('Accept', 'application/json').send({ hook: hook, data: data }).end(function () {});
}

module.exports = exports['default'];

}).call(this,"/src/js/phase2_app/tracking.js")

},{"./utils/Config":189,"./utils/Utils.jsx":190,"debug":2,"superagent":183,"superagent-django-csrf":182}],189:[function(require,module,exports){
'use strict';
...
var _meStoresUserStore = require('../me/stores/UserStore');

var _meStoresUserStore2 = _interopRequireDefault(_meStoresUserStore);

exports.getPic = function getPic(url) {
  var isProfile = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
  var alt = arguments.length <= 2 || arguments[2] === undefined ? '' : arguments[2];

  var urlx = !_meStoresUserStore2['default'].showUsersPics() && !isProfile ? '../static/images/user.jpg' : url;

  return _react2['default'].createElement('img', { key: urlx, src: urlx, alt: alt });
};
...
},{"../me/stores/UserStore":186,"react":162}],191:[function(require,module,exports){
'use strict';

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

var _phase2_appTracking = require('../phase2_app/tracking');

var _phase2_appTracking2 = _interopRequireDefault(_phase2_appTracking);

window.track = _phase2_appTracking2['default'];

},{"../phase2_app/tracking":188}]},{},[191])
